...
export default function SignIn({ providers }) {
  ...
  return (
    <div className="mx-auto text-center mt-14 border-[1.5px] w-[45%] rounded-lg shadow-md">
      ...
      <div className="flex flex-col gap-3 items-center mb-10">
        {Object.values(providers).map((provider) => {
          return (
            <div
              key={provider.name}
              className="flex items-center justify-center w-[260px]"
            >
              <button
                type="button"
                className={`w-full flex gap-3 font-poppins items-center focus:ring-2 focus:outline-none focus:ring-blue-400 font-regular rounded-lg px-5 py-2.5 mr-2 mb-2 ${
